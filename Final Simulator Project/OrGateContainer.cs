...
namespace Final_Simulator_Project
{
    ...
    {
        public SelectionRectangle selectionRectangle1 = new SelectionRectangle(2);
        public SelectionRectangle selectionRectangle2 = new SelectionRectangle(2);
        public SelectionRectangle selectionRectangle3 = new SelectionRectangle(2);
        ...
        protected override void OnLocationChanged(EventArgs e)
        {
            ...
            Change_Location(2, panel1, Connecting_Rectangle_1, Connecting_Rectangle_2, Connecting_Rectangle_3);
            ...
            {
                if (Temp_Output.Gate_Type == 2 && Temp_Output.Gate_Index == Public_Static_Variables.Reset_draw_rect)
                {
        ...
        protected override void OnMouseEnter(EventArgs e)
        {
            ...
            {
                if (Public_Static_Variables.Orgatecontainer[i].Location == this.Location)
                {
                    Public_Static_Variables.Reset_draw_rect = i;
                    break;
                }
            }
            Change_Back_Color(Color.LightBlue, 2, Public_Static_Variables.Reset_draw_rect);
        }
        protected override void OnMouseLeave(EventArgs e)
        {
            Change_Back_Color(Color.White, 2, Public_Static_Variables.Reset_draw_rect);
        }
        ...
        private void Menuitem_Click(object sender, EventArgs e)
        {
            ...
            Control panel1 = Public_Static_Variables.Orgatecontainer[num].Parent;
            panel1.Controls.Remove(Public_Static_Variables.Orgatecontainer[num]);

            int current_index = Public_Static_Variables.Reset_draw_rect;

            //value is modified here for each gate
            Do_My_Condition(panel1, 2, current_index);
            ...
            {
                if (Gate.GetType() == typeof(OrGateContainer))
                {
