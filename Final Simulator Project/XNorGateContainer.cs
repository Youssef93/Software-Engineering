...
{
    class XNorGateContainer : Gates
    {
        public XNor_SelectionRectangle selectionRectangle1 = new XNor_SelectionRectangle();
        public XNor_SelectionRectangle selectionRectangle2 = new XNor_SelectionRectangle();
        public XNor_SelectionRectangle selectionRectangle3 = new XNor_SelectionRectangle();
        ...
        protected override void OnLocationChanged(EventArgs e)
        {
            ...
            Change_Location(5, panel1, Connecting_Rectangle_1, Connecting_Rectangle_2, Connecting_Rectangle_3);
            Set_Screen_Connecting_Rectangles();

            foreach (INPUT Temp_input in Public_Static_Variables.Inputs_List)
            {
                if (Temp_input.Gate_Type == 5 && Temp_input.Gate_Index == Public_Static_Variables.Reset_draw_rect)
                {
            ...
            {
                if (Temp_Output.Gate_Type == 5 && Temp_Output.Gate_Index == Public_Static_Variables.Reset_draw_rect)
                {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.DrawEllipse(pen, X +width/2, Y+height/2-3, 5,5); //small circle
        }
        ...
        private void Menuitem_Click(object sender, EventArgs e)
        {
            ...
            Control panel1 = Public_Static_Variables.XNorgatecontainer[num].Parent;
            panel1.Controls.Remove(Public_Static_Variables.XNorgatecontainer[num]);

            int current_index = Public_Static_Variables.Reset_draw_rect;

            //value is modified here for each gate
            Do_My_Condition(panel1, 5, current_index);
            ...
            {
                if (Gate.GetType() == typeof(XNorGateContainer))
                {
