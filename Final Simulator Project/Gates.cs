...
namespace Final_Simulator_Project
{
        ...
        class Gates : UserControl
    {
        ...
        */
        ...
        {
            Connecting_Rectangle_1 = new Rectangle(2, 15 - 13/2, 13, 13);// initialize first rectangle
            Connecting_Rectangle_2 = new Rectangle(2, 5 - 13 / 2 + Public_Static_Variables.height, 13, 13);//initialize secind rectangle
            Connecting_Rectangle_3 = new Rectangle(38 + Public_Static_Variables.width, 4 + Public_Static_Variables.height / 2, 13, 13);
