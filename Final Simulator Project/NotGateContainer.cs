...
namespace Final_Simulator_Project
{
    class NotGateContainer : Gates
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            selectionRectangle1.Location = new Point(15 - selectionRectangle1.Width, this.Height/2 - selectionRectangle1.Height/2);
            ...
            selectionRectangle2.Connected = true;
        ...
        protected override void OnLocationChanged(EventArgs e)
        {
            ...
            {
                if (Temp_input.Gate_Type == 6 && Temp_input.Gate_Index == Public_Static_Variables.Reset_draw_rect)
                {
            ...
            {
                if (Temp_Output.Gate_Type == 6 && Temp_Output.Gate_Index == Public_Static_Variables.Reset_draw_rect)
                {
        ...
        protected override void OnMouseEnter(EventArgs e)
        {
            ...
            Change_Back_Color(Color.LightBlue, 6, Public_Static_Variables.Reset_draw_rect);
        }
        protected override void OnMouseLeave(EventArgs e)
        {
            Change_Back_Color(Color.White, 6, Public_Static_Variables.Reset_draw_rect);
        }
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.DrawLine(pen, new Point(X, this.Height/2), new Point(X - 25, this.Height/2));// first horizontal line
            g.DrawLine(pen, new Point(X + (width / 2), Y + (height / 2)), new Point(X + width, Y + (height / 2)));// last horizontal line
            g.DrawLine(pen, new Point(X, Y), new Point(X, Y + height)); //Vertical line
            g.DrawLine(pen, new Point(X, Y), new Point(X + width/2, Y + height / 2)); //upper bent line
            g.DrawLine(pen, new Point(X, Y + height), new Point(X + width / 2, Y + height / 2));// lower bent line
        }
        ...
        private void Menuitem_Click(object sender, EventArgs e)
        {
            ...
            //value is modified here for each gate
            Do_My_Condition(panel1, 6, current_index);
