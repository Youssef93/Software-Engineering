...
{
    class XOr_SelectionRectangle : SelectionRectangle
    {
        ...
        private void Add_Wires_To_List()
        {
            ...
            int Which_Rectangle = Index_Of_This_Control(rectangle, ref index, 4); // which rectangle in this gate
            ...
            if (Connect_Wires)
            {
                ...
                else if (Gate_Connected == Connection_State.Nand)
                {
                    ...
                    if (Add_Wire)
                    {
                        ...
                        Public_Static_Variables.Pair_Input_Output_Rectangles_Sorting.Add(Index_Of_First_Gate);
                        Public_Static_Variables.Pair_Input_Output_Rectangles_Sorting.Add(Rectangle_Of_First_Gate);
                        MyPanel.Add_Wires_To_Panel(4, index, Which_Rectangle, 1, Index_Of_First_Gate, Rectangle_Of_First_Gate, panel1);
                    }
                }
                else if (Gate_Connected == Connection_State.Or)
                {
                    ...
                    if (Add_Wire)
                    {
                        ...
                        Public_Static_Variables.Pair_Input_Output_Rectangles_Sorting.Add(Index_Of_First_Gate);
                        Public_Static_Variables.Pair_Input_Output_Rectangles_Sorting.Add(Rectangle_Of_First_Gate);
                        MyPanel.Add_Wires_To_Panel(4, index, Which_Rectangle, 2, Index_Of_First_Gate, Rectangle_Of_First_Gate, panel1);
                    }
                }
                else if (Gate_Connected == Connection_State.Nor)
                {
                    ...
                    if (Add_Wire)
                    {
                        ...
                        Public_Static_Variables.Pair_Input_Output_Rectangles_Sorting.Add(Index_Of_First_Gate);
                        Public_Static_Variables.Pair_Input_Output_Rectangles_Sorting.Add(Rectangle_Of_First_Gate);
                        MyPanel.Add_Wires_To_Panel(4, index, Which_Rectangle, 3, Index_Of_First_Gate, Rectangle_Of_First_Gate, panel1);
                    }
                }
                else if (Gate_Connected == Connection_State.XOr)
                {
                    ...
                    if (Add_Wire)
                    {
                        ...
                        Public_Static_Variables.Pair_Input_Output_Rectangles_Sorting.Add(Index_Of_First_Gate);
                        Public_Static_Variables.Pair_Input_Output_Rectangles_Sorting.Add(Rectangle_Of_First_Gate);
                        MyPanel.Add_Wires_To_Panel(4, index, Which_Rectangle, 4, Index_Of_First_Gate, Rectangle_Of_First_Gate, panel1);
                    }
                }
                else if (Gate_Connected == Connection_State.XNor)
                {
                    ...
                    if (Add_Wire)
                    {
                        ...
                        Public_Static_Variables.Pair_Input_Output_Rectangles_Sorting.Add(Index_Of_First_Gate);
                        Public_Static_Variables.Pair_Input_Output_Rectangles_Sorting.Add(Rectangle_Of_First_Gate);
                        MyPanel.Add_Wires_To_Panel(4, index, Which_Rectangle, 5, Index_Of_First_Gate, Rectangle_Of_First_Gate, panel1);
                    }
                }
                else if (Gate_Connected == Connection_State.Not)
                {
                    ...
                    if (Add_Wire)
                    {
                        ...
                        Public_Static_Variables.Pair_Input_Output_Rectangles_Sorting.Add(Index_Of_First_Gate);
                        Public_Static_Variables.Pair_Input_Output_Rectangles_Sorting.Add(Rectangle_Of_First_Gate);
                        MyPanel.Add_Wires_To_Panel(4, index, Which_Rectangle, 6, Index_Of_First_Gate, Rectangle_Of_First_Gate, panel1);
                    }
                }
            }
        }
