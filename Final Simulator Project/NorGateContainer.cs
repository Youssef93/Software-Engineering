...
namespace Final_Simulator_Project
{
    ...
    {
        public SelectionRectangle selectionRectangle1 = new SelectionRectangle(3);
        public SelectionRectangle selectionRectangle2 = new SelectionRectangle(3);
        public SelectionRectangle selectionRectangle3 = new SelectionRectangle(3);
        ...
        protected override void OnLocationChanged(EventArgs e)
        {
            ...
            {
                if (Temp_input.Gate_Type == 3 && Temp_input.Gate_Index == Public_Static_Variables.Reset_draw_rect)
                {
            ...
            {
                if (Temp_Output.Gate_Type == 3 && Temp_Output.Gate_Index == Public_Static_Variables.Reset_draw_rect)
                {
        ...
        protected override void OnMouseEnter(EventArgs e)
        {
            ...
            Change_Back_Color(Color.LightBlue, 3, Public_Static_Variables.Reset_draw_rect);
        }
        protected override void OnMouseLeave(EventArgs e)
        {
            Change_Back_Color(Color.White, 3, Public_Static_Variables.Reset_draw_rect);
        }
